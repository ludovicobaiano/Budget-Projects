      ...
      {!isAdmin && (
        <div className="p-3.5 bg-emerald-50 border border-emerald-200/90 rounded-2xl flex items-center justify-between text-xs text-emerald-800 font-medium shadow-2xs">
          <div className="flex items-center gap-2.5">
            ...
            <span>
              <strong>Modalità Visualizzatore (Sola Lettura):</strong> Sei connesso come solo visualizzatore. La registrazione, modifica ed eliminazione delle fatture sono riservate all'Amministratore.
            </span>
          </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs">
        ...
        {isAdmin ? (
          <button
            ...
            className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold flex items-center gap-2 transition-all shadow-xs shrink-0 cursor-pointer"
          >
